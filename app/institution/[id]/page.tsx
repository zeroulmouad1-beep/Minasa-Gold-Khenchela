...
const institutionTitles: Record<string, { title: string; description: string }> = {
  'museum': {
    ...
    description: 'المتحف العمومي الوطني بخنشلة (الاخوة الشهداء بولعزيز) هو صرح ثقافي يحتضن كنوز التراث الخنشلي والآثار التاريخية العريقة.',
  },
  'cinema': {
    title: 'قاعة السينيماتيك',
    description: 'قاعة السينيماتيك بخنشلة هي مركز ثقافي متميز يقدم عروضاً سينمائية متنوعة.',
  },
  'library': {
    title: 'المكتبة الرئيسية للمطالعة العمومية',
    description: 'المكتبة الرئيسية للمطالعة العمومية بخنشلة (الشهيد صيد لعروس) تحتوي على آلاف الكتب والمراجع.',
  },
  'culture-house': {
    title: 'دار الثقافة',
  ...
  'theater': {
    ...
    description: 'مسرح الهواء الطلق (حسينة لواج) بخنشلة هو فضاء فني مميز يستضيف العروض المسرحية والفنية.',
  },
}
